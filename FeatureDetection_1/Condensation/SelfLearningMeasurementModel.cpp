...
#include "SelfLearningMeasurementModel.hpp"
#include "Sample.hpp"
...
namespace Condensation
{
	...
	std::vector<cv::Mat> SelfLearningMeasurementModel::getFeatureVectors(std::vector<std::shared_ptr<detection::ClassifiedPatch>>& patches)
	{
