...
#ifndef FEATUREDETECTION_IMAGELOGGER_LOGGER_HPP_
#define FEATUREDETECTION_IMAGELOGGER_LOGGER_HPP_
#define FEATUREDETECTION_IMAGELOGGER_LOGGER_HPP_
...
private:
	 ...
	 * @param[in] logMessage The message to be logged.
	 */
	void log(const logging::LogLevel logLevel, const string logMessage);
