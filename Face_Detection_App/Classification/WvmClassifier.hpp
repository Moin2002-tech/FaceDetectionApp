...
#ifndef FEATUREDETECTION_CLASSIFICATION_WVMCLASSIFIER_HPP_ 
#define FEATUREDETECTION_CLASSIFICATION_WVMCLASSIFIER_HPP_
	...
	*/
	...
	public:
		...
		*/
		 ...
		 */
		std::pair<int, double> hyperPlaneDistance(const cv::Mat& featureVector) const;
		...
		*/
		static std::shared_ptr<WvmClassifier> loadFromMATLAB(const std::string& classifierFileName, const std::string& threshholdsFileName);

		int getNumUsedFilter(void);
...
#endif //FEATUREDETECTION_CLASSIFICATION_WVMCLASSIFIER_HPP_ 
