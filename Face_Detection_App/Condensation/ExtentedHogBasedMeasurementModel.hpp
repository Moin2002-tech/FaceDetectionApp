#pragma once
/*
* ExtentedHogBasedMeasurementModel.hpp
* Created on: 1/2/2025
* Author : Moin Shaikh
*/


#ifndef FEATUREDETECTION_CONDENSATION_EXTENTEDHOGBASEDMEASUREMENTMODEL_HPP_
#define FEATUREDETECTION_CONDENSATION_EXTENTEDHOGBASEDMEASUREMENTMODEL_HPP_	
...
{
	class ExtendedHogBasedMeasurementModel : public AdaptiveMeasurementModel, StateValidator
	{
		/**
		...
		*/             
		...
		explicit ExtendedHogBasedMeasurementModel(
			std::shared_ptr<Classification::TrainableProbabilisticSvmClassifier> classifier);

		/**
		 * Constructs a new extended HOG based measurement model that uses the given image pyramid
		 * for the feature extraction.
		 * @param[in] classifier The trainable SVM classifier.
		 * @param[in] basePyramid Grayscale image pyramid that is used as the base for feature extraction.
		*/
		ExtendedHogBasedMeasurementModel(
			std::shared_ptr<Classification::TrainableProbabilisticSvmClassifier> classifier,
			std::shared_ptr<ImageProcessing::ImagePyramid> basedPyramid
		);
...
#endif //FEATUREDETECTION_CONDENSATION_EXTENTEDHOGBASEDMEASUREMENTMODEL_HPP_