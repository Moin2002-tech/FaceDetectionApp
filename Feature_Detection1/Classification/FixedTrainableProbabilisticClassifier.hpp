...
#ifndef FEATUREDETECTION_CLASSIFICAITON_FIXEDTRAINABLE_PROBABILISTIC_SVMCLASSIFIER_HPP_
#define FEATUREDETECTION_CLASSIFICAITON_FIXEDTRAINABLE_PROBABILISTIC_SVMCLASSIFIER_HPP_
...
namespace Classification
{
	...
	*/
	...
	public:
	   ...
	   */
		FixedTrainableProbabilisticSvmClassifier(std::shared_ptr<TrainableSvmClassifier> trainableSvm, double logisticA, double logisticB) : TrainableProbabilisticSvmClassifier(trainableSvm,0,0), logisticA(logisticA), logisticB(logisticB) {}
...
#endif // !FEATUREDETECTION_CLASSIFICAITON_FIXEDTRAINABLE_PROBABILISTIC_SVMCLASSIFIER_HPP_
