...
#ifndef FEATUREDETECTION_RENDER_CAMERA_HPP_
#define FEATUREDETECTION_RENDER_CAMERA_HPP_
...
namespace Render 
{
	 ...
	 */
		...
		Camera(Vec3f eyePosition, Vec3f gazePosition, Frustum);
		...
		const Vec3f& getAt() const
		{ return gaze; }

		const Vec3f& getUp() const
		{ return up; }

		const Vec3f& getForwardVector() const
		{ return forwardVector; }

		const Vec3f& getRightVector() const
		{ return rightVector; }
...
#endif //FEATUREDETECTION_MORPHALMODEL_CAMERA_HPP_