...
#ifndef FEATUREDETECTION_IMAGELOGGER_IMAGELOGGERFACTORY_HPP_
#define FEATUREDETECTION_IMAGELOGGER_IMAGELOGGERFACTORY_HPP_

#include "ImageLogger.hpp" // We wouldn't need this include, we could use a forward declaration. But this way, our libs/apps only have to include one file to use the logger.
#include "imageloglevels.hpp" // Same as for ImageLogger.hpp.
