#pragma once
/*
* File: ExtendedHogFilter.hpp
* Created on: 10/2/2025
* Author : Moin Shaikh
*/


#ifndef FEATUREDETECTION_IMAGEPROCESSING_EXTENDEDHOGFILTER_HPP_
#define FEATUREDETECTION_IMAGEPROCESSING_EXTENDEDHOGFILTER_HPP_
