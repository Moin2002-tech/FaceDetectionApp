/*
* File: AggregatedExtractionFilter.hpp
* Created on: 20/2/2025
* Author : Moin Shaikh
*/

#include "../../ImageProcessing/Extraction/AggregatedExtractionFilter.hpp"
...
namespace ImageProcessing
{
	namespace Extraction
	{
		...
		{
			Rect boundsInImagePixels = Patch::computeBounding(Point(centerX, centerY), Size(width, height));
		...
		shared_ptr<Patch> AggregatedFeaturesExtractor::extract(Rect bounds) const 
		{
			...
			return extract(*layer, Patch::computeBounding(centerInLayerCells, patchSizeInCells));
		}
