/*
* File: IntegralChannelHistogramFilter.cpp
* Created on: 15/2/2025
* Author : Moin Shaikh
*/


#include"IntegralChannelHistogramFilter.hpp"
#include<stdexcept>
		...
		for (unsigned int i = 0; i < blockRows; ++i) 
		{
			for (unsigned int j = 0; j < blockColumns; ++j) 
			{
				...
				else 
				{
					...
					}// normalization == Normalization::L1NORM || normalization == Normalization::L1SQRT
