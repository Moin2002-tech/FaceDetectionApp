/*
* File: IntegralChannelFeatureFilter.cpp
* Created on: 15/2/2025
* Author : Moin Shaikh
*/

#include"IntegralChannelFeatureFilter.hpp"
#include<stdexcept>
...
{
	IntegralChannelFeatureFilter::IntegralChannelFeatureFilter(unsigned int blockRows, 
		unsigned int blockColumns, double overlap) :
