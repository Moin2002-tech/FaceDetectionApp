...
namespace ImageProcessing
{
	...
	ExtendedHogFilter::ExtendedHogFilter(int binCount, int cellWidth, int cellHeight, 
		bool interpolate, bool signedAndUnsigned, float alpha) :
		HistogramFilter(Normalization::L2HYS),
		binCount(binCount),
		cellWidth(cellWidth),
