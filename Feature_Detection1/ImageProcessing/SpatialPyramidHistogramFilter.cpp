/*
* File: SpatialPyramidHistogramFilter.cpp
* Created on: 12/2/2025
* Author : Moin Shaikh
*/


#include"SpatialPyramidHistogramFilter.hpp"
#include<vector>
#include<stdexcept>
...
namespace ImageProcessing
{
	...
	SpatialPyramidHistogramFilter::SpatialPyramidHistogramFilter(int binCount, int levelCount,
		bool interpolate,Normalization normalization) : HistogramFilter(normalization),binCount(binCount),
	...
	void SpatialPyramidHistogramFilter::createCellHistograms(const Mat& image, float* histogramsValues,
		int level, int binCount, bool interpolate) const
	{
	...
	void SpatialPyramidHistogramFilter::combineHistograms(const float* cellHistogramsValues, 
