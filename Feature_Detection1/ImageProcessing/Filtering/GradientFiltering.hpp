#pragma once
/*
* File: GradientFiltering.hpp
* Created on: 10/2/2025
* Author : Moin Shaikh
*/

#ifndef FEATUREDETECTION_IMAGEPROCESSING_FILTERING_GRADIENTFILTERING_HPP_
#define FEATUREDETECTION_IMAGEPROCESSING_FILTERING_GRADIENTFILTERINGs_HPP_
