#pragma once
/*
* File: GradientHistogramFilter.hpp
* Created on: 10/2/2025
* Author : Moin Shaikh
*/

#ifndef FEATUREDETECTION_IMAGEPROCESSING_FILTERING_GRADIENTHISTOGRAMFILTER_HPP_
#define FEATUREDETECTION_IMAGEPROCESSING_FILTERING_GRADIENTHISTOGRAMFILTER_HPP_
		...
		*/
		...
		public:
			...
			GradientHistogramFilter(int binCount, bool interpolate,
				bool half, bool full,
				bool magnitude, 
				int normalizationRadius = 5, 
				double normalizationConstant = 0.01);
...
#endif //FEATUREDETECTION_IMAGEPROCESSING_FILTERING_GRADIENTHISTOGRAMFILTER_HPP_