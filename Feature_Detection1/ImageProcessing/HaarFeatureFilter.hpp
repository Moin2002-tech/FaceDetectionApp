...
/*
* File: HaarFeatureFilter.hpp
* Created on: 10/2/2025
* Author : Moin Shaikh
*/
#ifndef FEATUREDETECTION_IMAGEPROCESSING_HAARFEATUREFILTER_HPP_
#define FEATUREDETECTION_IMAGEPROCESSING_HAARFEATUREFILTER_HPP_
...
#endif //FEATUREDETECTION_IMAGEPROCESSING_HAARFEATUREFILTER_HPP_