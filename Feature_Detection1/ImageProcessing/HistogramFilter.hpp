...
#ifndef FEATUREDETECTION_IMAGEPROCESSING_HISTOGRAMFILTER_HPP_
#define FEATUREDETECTION_IMAGEPROCESSING_HISTOGRAMFILTER_HPP_
...
namespace ImageProcessing {
	...
	public:
		 ...
		 */
		virtual void createCellHistograms(const cv::Mat& image, cv::Mat& histograms, int binCount, int rowCount, int columnCount, bool interpolate) const = 0;
		...
		static constexpr float eps = 1e-4; ///< The small value being added to the norm to prevent division by zero.
...
#endif /* FEATUREDETECTION_IMAGEPROCESSING_HISTOGRAMFILTER_HPP_ */