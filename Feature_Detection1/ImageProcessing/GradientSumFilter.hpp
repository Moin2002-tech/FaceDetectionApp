#pragma once
/*
* File: GradientSumFilter.hpp
* Created on: 10/2/2025
* Author : Moin Shaikh
*/


#ifndef FEATUREDETECTION_IMAGEPROCESSING_GRADIENTSUMFILTER_HPP_
#define FEATUREDETECTION_IMAGEPROCESSING_GRADIENTSUMFILTER_HPP_
